...
struct task_struct* thread_start(char* name, int prio, thread_func function, void* func_arg){
    ...
    print_int(thread);print_str(" ");
    print_int(thread->self_kernel_stack);print_str(" ");
    print_str(thread->name);print_str(" ");
    print_int(thread->priority);print_str(" ");
    print_str((char*) func_arg);print_str("\n");
//    ASSERT(1 == 2);
