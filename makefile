...
CFLAGS = -Wall -m32 $(LIB) -c -fno-builtin -W -Wstrict-prototypes \
         -Wmissing-prototypes -gstabs -nostdinc -fno-stack-protector -no-pie -fno-pic
...
$(BUILD_DIR)/stdio.o: lib/stdio.c lib/stdio.h lib/string.h lib/user/syscall.h lib/kernel/print.h \
